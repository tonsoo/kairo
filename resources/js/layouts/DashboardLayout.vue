...
<template>
    <div class="min-h-screen bg-[#1e1f20] font-sans text-slate-300">
        <div class="flex min-h-screen">
            <aside
                class="hidden w-72 shrink-0 border-r border-[#2e2f30] bg-[#18191a] md:flex md:flex-col"
            >
