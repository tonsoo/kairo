...
<template>
    <div class="grid gap-5 rounded-2xl border border-border bg-card p-5 xl:grid-cols-[11rem_minmax(0,18rem)_minmax(0,1fr)]">
        <div class="space-y-1">
        ...
        <div class="space-y-2">
            <span class="text-sm text-muted-foreground">{{ i18n.global.t('weekly_schedule.field.day_type') }}</span>
