...
<template>
    <footer id="privacidade" class="border-t border-[#2e2f30] bg-[#18191a] px-6 pb-8 pt-16">
        <div class="mx-auto mb-12 grid max-w-7xl grid-cols-1 gap-12 md:grid-cols-4">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-500">
                    ...
                    <li><a href="#privacidade" class="transition-colors hover:text-teal-400">{{ translate('home.footer.product.security', locale) }}</a></li>
                    <li><a href="#" class="transition-colors hover:text-teal-400">{{ translate('home.footer.product.pricing', locale) }}</a></li>
                </ul>
            </div>
            <div>
                <h4 class="mb-4 font-semibold text-slate-200">{{ translate('home.footer.legal', locale) }}</h4>
                <ul class="space-y-3 text-sm text-slate-500">
                    <li><a href="#" class="transition-colors hover:text-teal-400">{{ translate('home.footer.legal.terms', locale) }}</a></li>
                    <li><a href="#" class="transition-colors hover:text-teal-400">{{ translate('home.footer.legal.privacy', locale) }}</a></li>
                    <li><a href="#" class="transition-colors hover:text-teal-400">{{ translate('home.footer.legal.contact', locale) }}</a></li>
                </ul>
            </div>
        </div>
